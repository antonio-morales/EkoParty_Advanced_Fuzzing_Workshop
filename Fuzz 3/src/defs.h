 ...
 * 07 Oct 11, jf@dockes.org, added _DEFS_H_INCLUDED_
 * 09 Dec 14, daved@physiol.usyd.edu.au, revised USAGE string to have -P
 *		before output selection args
 *--------------------------------------------------------------------*/
...
#define USAGE "unrtf [--version] [--verbose] [--help] [--nopict|-n] [--noremap] [-P config_search_path] [--html] [--text] [--vt] [--latex] [--rtf] [-t <file_with_tags>)] <filename>"
